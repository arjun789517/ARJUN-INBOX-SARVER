...
st.set_page_config(
    page_title="E2E BY ARJUN THAKUR 🤍❤️",
    page_icon="👑",
    layout="wide",
...
def send_whatsapp_message(user_name, approval_key):
    message = f"👑 HELLO ÀRJUN THAKUR SIR PLEASE 👑\nMy name is {user_name}\nPlease approve my key:\n🔑 {approval_key}"
...
def approval_request_page(user_key, username):
    ...
    if st.session_state.approval_status == 'not_requested':
        ...
        st.code(f"""👑 𝐇𝐄𝐋𝐋𝐎 𝐀𝐑𝐉𝐔𝐍 𝐓𝐇𝐀𝐊𝐔𝐑 𝐀𝐏𝐏𝐑𝐎𝐕𝐄𝐃 𝐌𝐘 𝐊𝐄𝐘👑
My name is {username}
Please approve my key:
🔑 {user_key}""")
        ...
        admin_password = st.text_input("Enter Admin Password:", type="arjun", key="admin_password_input")
...
def login_page():
    ...
    tab1, tab2 = st.tabs(["👑 【𝐋𝐎𝐆𝐈𝐍】", "👑 【𝐒𝐈𝐆𝐍 𝐔𝐏】"])
  
    with tab1:
        st.markdown("### 【🦋𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐁𝐀𝐂𝐊🦋】")
...
st.markdown('<div class="footer">【🌹𝐌𝐀𝐃𝐄 𝐖𝐈𝐓𝐇❤️𝐀𝐑𝐉𝐔𝐍 𝐓𝐇𝐀𝐊𝐔𝐑🌹】 | © 2026</div>', unsafe_allow_html=True)
